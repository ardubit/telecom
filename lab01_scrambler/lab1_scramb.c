...
1. Функцію, що реалізує роботу скремблера
2. Функцію, що реалізує роботу дескремблера
3. Функцію, яка генерує випадкову послідовність 0 і 1 завдовжки K
4. Перевірити правильність функціонування
5. Поелементно порівняти вихідну та дескрембльовану послідовності
========================================
